...
func main() {
	pulumi.Run(func(ctx *pulumi.Context) error {
		...
		staticWebsite, err := storage.NewStorageAccountStaticWebsite(ctx, "staticSite", &storage.StorageAccountStaticWebsiteArgs{
		...
		ctx.Export("staticSiteUrl", account.PrimaryEndpoints.Web())
